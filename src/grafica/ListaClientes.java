...
public class ListaClientes extends javax.swing.JFrame {
    ...
    public ListaClientes() {
        ...
        ArrayList<String> strings = tc.clientesTodos();
    ...
    private void BotaoComprasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoComprasActionPerformed
        // TODO add your handling code here
        negocio.TodosClientes tc = new negocio.TodosClientes();
        int num = Integer.parseInt(NumeroApagado.getText());
        num = tc.encontrarPosCliente(num);
        ArrayList<negocio.Cliente> clientes = new ArrayList<>();
        ArrayList<String> strings = clientes.get(num).historicoCompras;
        ListaPessoas.setModel(new javax.swing.AbstractListModel<String>() {
            @Override
            public int getSize() { return strings.size(); }
            public String getElementAt(int i) { return strings.get(i); }
